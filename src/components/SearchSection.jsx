...
const SearchSection = ({ value, onChange, onClickSearch, onClickFetch }) => {
  return (
    <div className='flex items-center w-full h-9 gap-2'>
        ...
        <div>
            <button onClick={onClickFetch} className='flex h-full w-9 border-2 rounded-lg items-center  text-lg border-[#695cfe] transition-all duration-700 hover:bg-[#695cfe]'>
